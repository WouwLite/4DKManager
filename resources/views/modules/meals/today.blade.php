...
@section('content_header')
    ...
    <h1>@include('includes/goBack') Maaltijduitgifte</h1>
@stop
...
@section('content')
    ...
    <div class="table-responsive">
        ...
        <h4>Overzicht van maaltijden van deelnemers voor <b>{{ date("l") . " " . $currentDate }}</b></h4>
...
{{--                        <td>{{ $meal->date }}</td>--}}
                        ...
                        <td>
                            ...
                            @if($meal->breakfast == 1)
                                <form>
                                    <input id="breakfast" name="breakfast" type="hidden" value="2">
                                    <button type="submit" class="btn btn-primary" value="2">Gereed</button>
                                </form>
                            @else
                                <input id="breakfast" name="breakfast" type="hidden" value="1">
                                <button type="submit" class="btn btn-success" value="1">Yay!</button>
                            @endif
